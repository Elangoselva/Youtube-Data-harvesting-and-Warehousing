...
atlas_username = 'elango'
atlas_password = 'ELAngo'
atlas_cluster = 'Cluster0'
client = MongoClient(
    f"mongodb+srv://{atlas_username}:{atlas_password}@{atlas_cluster}.hxx96ie.mongodb.net/?retryWrites=true&w=majority")
# mongodb+srv://elango:<password>@cluster0.hxx96ie.mongodb.net/?retryWrites=true&w=majority
db = client['youtube_data']
collection = db['channel_data']
# api_key
Api_key = 'AIzaSyB6AZCzoKoimG6FN8gm_QdVT9FqSPvhKIs'
